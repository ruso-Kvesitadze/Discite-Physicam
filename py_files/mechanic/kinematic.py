from flask import Flask,  app, render_template, request, Blueprint


import math

kinematic= Blueprint ("kinematic", __name__ , static_folder="static", template_folder="templates")
...
"""
open search bar   ctrl+p       #-all files    @-in this file    @:symbols in this file


ვარდნილი სხეული                         time_calculate_fallen
გასროლილი სხეული                        gasrolili_distance
ასროლილი სხეული                         asrolili_time
სიმაღლდიან გასროლილი სხეული            height_gasrolili_distance
სიმაღლდიან ჩამოსროლილი სხეული          chamosrolili_distance
...
@kinematic.route('/calculator/mechanic/kinematika/fallen/time/' ,  methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/fallen/instant_velocity/' ,  methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/fallen/height/' ,  methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/fallen/initial_velocity/' ,  methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/fallen/in_n_time_dist/' ,  methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/fallen/in_n_meter_time/' ,  methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/fallen/last_n_meter_time/' ,  methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/fallen/last_n_time_dist/' ,  methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/gasrolili/distance/', methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/gasrolili/height/', methods=['GET','POST'])
def getvalue_height():
...
@kinematic.route('/calculator/mechanic/kinematika/gasrolili/time/', methods=['GET','POST'])
def getvalue_time():
    gravity=float(request.form['gravity'])
    angle_user=float(request.form['angle'])
    velocity=float(request.form['selectable'])
...
@kinematic.route('/calculator/mechanic/kinematika/gasrolili/initaial_velocity/', methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/gasrolili/angle/', methods=['GET','POST'])
def getvalue_angle():
    gravity=float(request.form['gravity'])
...
@kinematic.route('/calculator/mechanic/kinematika/gasrolili/instant_velocity/', methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/gasrolili/instant_positon/', methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/asrolili/time/calculate')
def asrolili_time():
    return render_template('/mechanic/kinematika/asrolili/time.html')


@kinematic.route('/calculator/mechanic/kinematika/asrolili/time/', methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/asrolili/instant_velocity/calculate')
def asrolili_instant_velocity():
    return render_template('/mechanic/kinematika/asrolili/instant_velocity.html')


@kinematic.route('/calculator/mechanic/kinematika/asrolili/instant_velocity/', methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/asrolili/initial_height/', methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/asrolili/initial_velocity/calculate')
def asrolili_initial_velocity():
    return render_template('/mechanic/kinematika/asrolili/initial_velocity.html')


@kinematic.route('/calculator/mechanic/kinematika/asrolili/initial_velocity/', methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/asrolili/height/calculate')
def asrolili_height():
    return render_template('/mechanic/kinematika/asrolili/height.html')


@kinematic.route('/calculator/mechanic/kinematika/asrolili/height/', methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/asrolili/displacement/calculate')
def asrolili_displacement():
    return render_template('/mechanic/kinematika/asrolili/displacement.html')


@kinematic.route('/calculator/mechanic/kinematika/asrolili/displacement/', methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/asrolili/in_n_time_dis/calculate')
def asrolili_in_n_time_dis():
    return render_template('/mechanic/kinematika/asrolili/in_n_time_dis.html')


@kinematic.route('/calculator/mechanic/kinematika/asrolili/in_n_time_dis/' , methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/asrolili/in_n_meter_time/' , methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/asrolili/last_n_time_dis/calculate')
def asrolili_last_n_time_dis():
    return render_template('/mechanic/kinematika/asrolili/last_n_time_dis.html')


@kinematic.route('/calculator/mechanic/kinematika/asrolili/last_n_time_dis/' , methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/asrolili/first_n_time_dis/' , methods=['GET','POST'])
...
@kinematic.route('//calculator/mechanic/kinematika/asrolili/last_n_meter_time/' , methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/asrolili/first_n_meter_time/calculate')
def asrolili_first_n_meter_time():
    return render_template('/mechanic/kinematika/asrolili/first_n_meter_time.html')


@kinematic.route('//calculator/mechanic/kinematika/asrolili/first_n_meter_time/' , methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/height_gasrolili/distance/calculate')
def height_gasrolili_distance():
    return render_template('/mechanic/kinematika/height_gasrolili/dist.html')


@kinematic.route('/calculator/mechanic/kinematika/height_gasrolili/distance/', methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/height_gasrolili/height/', methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/height_gasrolili/time/calculate')
def height_gasrolili_time():
    return render_template('/mechanic/kinematika/height_gasrolili/time.html')


@kinematic.route('/calculator/mechanic/kinematika/height_gasrolili/time/', methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/height_gasrolili/angle/', methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/height_gasrolili/instant_positon/calculate')
def height_gasrolili_position_x_y():
    return render_template('/mechanic/kinematika/height_gasrolili/instant_positon.html')


@kinematic.route('/calculator/mechanic/kinematika/height_gasrolili/instant_positon/', methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/height_gasrolili/fall_angle/', methods=['GET','POST'])
...
@kinematic.route('/calculator/mechanic/kinematika/height_gasrolili/initial_height/calculate')
def height_gasrolili_initial_height():
    return render_template('/mechanic/kinematika/height_gasrolili/initial_height.html')


@kinematic.route('/calculator/mechanic/kinematika/height_gasrolili/initial_height/' , methods=['GET','POST'])
...
#სიმაღლდიან ჩამოსროლილი სხეულისთვის ითვლის ვარდნის სიშორეს
@kinematic.route('/calculator/mechanic/kinematika/chamosrolili/distance/calculate')
def chamosrolili_distance():
    return render_template('/mechanic/kinematika/chamosrolili/dist.html')


@kinematic.route('/calculator/mechanic/kinematika/chamosrolili/distance/', methods=['GET','POST'])
def chamosrolili_distance_calc():
    gravity=float(request.form['gravity'])
    angle=float(request.form['angle'])
    velocity=float(request.form['initial_speed'])
    initial_height=float(request.form['initial_height'])
    ...
    if angle<=1.5708:
        ...
        distance=(math.sqrt(velocity**4 * math.sin(2*angle)**2 + 8 * gravity * initial_height * velocity_X**2 ) - velocity**2 * math.sin(2*angle)) / (2* gravity)

        distance=round(distance,2)

        return render_template('/mechanic/kinematika/chamosrolili/dist.html', distance=distance , Dimension="მ" ,)
    else:
...
@kinematic.route('/calculator/mechanic/kinematika/chamosrolili/time/calculate')
def chamosrolili_time():
    return render_template('/mechanic/kinematika/chamosrolili/time.html')


@kinematic.route('/calculator/mechanic/kinematika/chamosrolili/time/', methods=['GET','POST'])
def chamosrolili_getvalue_time():
    ...
    if  angle<=1.5708 :
        ...
        return render_template('/mechanic/kinematika/chamosrolili/time.html', time=time, Dimension="წმ" )
...
def chamosrolili_getvalue_velocity():
    ...
    if choose == "საწყისი სიმაღლე" and angle<=1.5708 :
        
        initial_velocity= (2*selectable - gravity*time**2) / (2*time*math.sin(angle))

        initial_velocity=round(initial_velocity,2)

        
        return render_template('/mechanic/kinematika/chamosrolili/initaial_velocity.html', initial_velocity=initial_velocity, Dimension="მ/წმ" )


    elif choose == "საწყისი სიმაღლე" and angle==0 :    
    ...
    elif choose == "საბოლოო სიჩქარე" and angle<=1.571 :
    
        initial_velocity= ( math.sqrt(4*(math.sin(angle)**2) * (gravity**2) * (time**2) - 4*((gravity**2) * (time**2) - (selectable**2))) - 2*math.sin(angle)*gravity*time ) / 2 
    ...
    elif choose == "საბოლოო სიჩქარე" and angle==0 :
    
        initial_velocity= math.sqrt(selectable**2  -  (gravity*time)**2)
        initial_velocity=round(initial_velocity,2)
        ...
        initial_velocity= selectable / (time * math.cos(angle))
...
@kinematic.route('/calculator/mechanic/kinematika/chamosrolili/angle/calculate')
def chamosrolili_angle():
    return render_template('/mechanic/kinematika/chamosrolili/angle.html')


@kinematic.route('/calculator/mechanic/kinematika/chamosrolili/angle/', methods=['GET','POST'])
def chamosrolili_getvalue_angle2():
    gravity=float(request.form['gravity'])
    initaial_velocity=float(request.form['initaial_velocity'])
    time=float(request.form['time'])
    selectable=float(request.form['selectable'])
    ...
    if choose=="ფრენის მანძილი":
        
        if selectable==0 and initaial_velocity>=0 and time>0:
            angle=90
            return render_template('/mechanic/kinematika/chamosrolili/angle.html', angle=angle, Dimension="°" )
        
        elif selectable>0 and initaial_velocity>0 and time>0:

            check_radian= selectable / (time * initaial_velocity)

            if check_radian>=0 and check_radian<=1.5708:
                angle=math.acos(selectable / (time * initaial_velocity))
                angle=round((math.degrees(angle)),2)
                return render_template('/mechanic/kinematika/chamosrolili/angle.html', angle=angle, Dimension="°" )
    ...
    if choose=="საწყისი სიმაღლე":
         
        if initaial_velocity==0 and 2*selectable==gravity*time**2:
            angle=90
            return render_template('/mechanic/kinematika/chamosrolili/angle.html', angle=angle, Dimension="°" )

        if  initaial_velocity>0 and time>0:
            chack_it= (2*selectable - gravity*time**2) / ( 2 * initaial_velocity * time)

            if chack_it>=0 and chack_it<=1.5708 and (2*selectable - gravity*time**2)<=( 2 * initaial_velocity * time) :
                angle=math.asin(chack_it)
                angle=round((math.degrees(angle)),2)
                return render_template('/mechanic/kinematika/chamosrolili/angle.html', angle=angle, Dimension="°" )
            else:
                return render_template('/mechanic/kinematika/chamosrolili/angle.html', angle="შეუძლებელია" )
    ...
    if choose=="საბოლოო სიჩქარე":

        if initaial_velocity==0 and time>0 and( initaial_velocity+gravity*time)==selectable:
            angle=90
            return render_template('/mechanic/kinematika/chamosrolili/angle.html', angle=angle, Dimension="°" )

        if initaial_velocity>0 and time>0:
            chack_it=(selectable**2 - gravity**2 * time**2 - initaial_velocity**2) / (2*gravity*initaial_velocity*time)

            if chack_it>=0 and chack_it<=1.5708 and (selectable**2 - gravity**2 * time**2 - initaial_velocity**2) <= (2*gravity*initaial_velocity*time):
                angle= math.asin((selectable**2 - gravity**2 * time**2 - initaial_velocity**2) / (2*gravity*initaial_velocity*time))
                angle=round((math.degrees(angle)),2)
                return render_template('/mechanic/kinematika/chamosrolili/angle.html', angle=angle, Dimension="°" )
            else:
                return render_template('/mechanic/kinematika/chamosrolili/angle.html', angle="შეუძლებელია" )
...
def chamosrolili_get_value_inst_velocity():
    ...
    velocity_Y=initaial_velocity*math.sin(angle)
    velocity_X=initaial_velocity*math.cos(angle)

    time_full= (-velocity_Y + math.sqrt(2*initial_height*gravity + velocity_Y**2)) / gravity

    if time<=time_full:
        inst_Y=velocity_Y + gravity*time
        inst_E= math.sqrt(inst_Y**2 + velocity_X**2)
        inst_X=velocity_X
...
@kinematic.route('/calculator/mechanic/kinematika/chamosrolili/instant_positon/calculate')
def chamosrolili_position_x_y():
    return render_template('/mechanic/kinematika/chamosrolili/instant_positon.html')


@kinematic.route('/calculator/mechanic/kinematika/chamosrolili/instant_positon/', methods=['GET','POST'])
def chamosrolili_get_value_position_x_y():
    gravity=float(request.form['gravity'])
    initaial_velocity=float(request.form['initaial_velocity'])
    initial_height=float(request.form['initial_height'])
    time=float(request.form['time'])
    ...
    if  angle<=1.5708 and time<=time_full:
        ...
        return render_template('/mechanic/kinematika/chamosrolili/instant_positon.html' ,X=position_X , Y=position_Y , Dimension="მ" )
...
def chamosrolili_fall_angle():
    return render_template('/mechanic/kinematika/chamosrolili/fall_angle_calc.html')


@kinematic.route('/calculator/mechanic/kinematika/chamosrolili/fall_angle/', methods=['GET','POST'])
def chamosrolili_getvalue_fall_angle():
    gravity=float(request.form['gravity'])
    initaial_velocity=float(request.form['initaial_velocity'])
    initial_height=float(request.form['initial_height'])
    angle=float(request.form['angle'])
    ...
    if angle<=1.5708:
        ...
        velocity_Y_last= velocity_Y + time_full * gravity

        fall_angle= math.atan(velocity_Y_last / velocity_X )
        
        fall_angle=round((math.degrees(fall_angle)),2)
        
        return render_template('/mechanic/kinematika/chamosrolili/fall_angle_calc.html', fall_angle=fall_angle, Dimension="°" )   
...
#სიმაღლდიან ჩამოსროლილი სხეულისთვის ითვლის საწყის სიმაღლეს
@kinematic.route('/calculator/mechanic/kinematika/chamosrolili/initial_height/calculate')
def chamosrolili_initial_height():
    return render_template('/mechanic/kinematika/chamosrolili/initial_height.html')


@kinematic.route('/calculator/mechanic/kinematika/chamosrolili/initial_height/' , methods=['GET','POST'])
def chamosrolili_initial_height_calculate():
    gravity=float(request.form['gravity'])
    initaial_velocity=float(request.form['initaial_velocity'])
    angle=float(request.form['angle'])
    selectable=float(request.form['selectable'])
    ...
    if choose=="ფრენის დრო" and angle<=1.5708:
        ...
        initial_height= velocity_Y*selectable + (gravity*selectable**2)/2
        
        initial_height= round(initial_height , 2)

        return render_template('/mechanic/kinematika/chamosrolili/initial_height.html', initial_height=initial_height, Dimension='მ' )
